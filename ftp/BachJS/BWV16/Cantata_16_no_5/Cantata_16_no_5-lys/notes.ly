...
\header {
 title = \markup \center-column { "Aria - Geliebter Jesu" }
 subtitle = \markup \center-column { "From Cantata No. 16" }
...
TenoreNotes = \new Voice = "TenoreVoice" { \relative c' {
	...
	\tag #'TenoreEnglishTPart \set Score.skipBars = ##t
		...
		%{ Bar 51 %} d4 r8 c8 \noBeam ees d=' \noBeam \endline
		%{ Bar 52 %} c8 [bes16 a bes8] g \noBeam e'! f=' \noBeam \endline
		\mBreak

		%{ Bar 53 %} g8 \noBeam bes, \noBeam d c \noBeam bes16 g a d=' \endline
		%{ Bar 54 %} c [f e d] c [bes] a8 \noBeam bes g= \noBeam \endline
		...
		%{ Bar 71 %} r4 \fermata r8 a8 \noBeam a a= \noBeam \endline
		%{ Bar 72 %} d8 [f16 e f8] a, \noBeam a a= \noBeam \endline
		\mBreak

		%{ Bar 73 %} e'8 g16 [(f g8)] a, \noBeam a a= \noBeam \endline
		%{ Bar 74 %} f'8 [a16 g a8] d, \noBeam g e=' \noBeam \endline
...
TenoreLyricsGerman = \new Lyrics \lyricsto "TenoreVoice" {
		...
		%{ Bar 17 %} Ge -- lieb -- _ _ ter _
		%{ Bar 18 %} Je -- su, du, _ du al -- _
		%{ Bar 19 %} lein,

		%{ Bar 21 %} ge -- lieb -- _ _  ter _
		...
		%{ Bar 30 %} lein, _ ge -- _ lieb -- _ ter _
		...
		%{ Bar 37 %} Ge -- lieb -- _ _ ter _
		%{ Bar 38 %} Je -- su,
		%{ Bar 39 %} ge -- lieb -- _ _ ter _
		...
		%{ Bar 89 %} ja, ja,
		%{ Bar 90 %} wenn _ das _ Le -- bens -- _ band _ zer --
		%{ Bar 91 %} reisst, ja, wenn _ das _
		%{ Bar 92 %} Le -- _ _ _ _ bens -- band _ zer -- _

		%{ Bar 93 %} reisst, stimmt un -- ser
		%{ Bar 94 %} gott -- ver -- _ gnüg -- _ ter _ Geist noch _
		%{ Bar 95 %} mit den _ Lip -- _ pen _ sehn -- _ lich
		%{ Bar 96 %} ein: Ge -- lieb -- _ _ ter _
	...
	<<
		...
		\tag #'score \tag #'OboeDaCacciaPart \new Staff { <<
			...
			\global \set Staff.instrumentName = \markup {  \column {
				\center-column {
					 \hcenter-in # centerIndent  "Oboe di caccia"
